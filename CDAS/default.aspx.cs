...
namespace CDAS
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btn_login_maint_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            //{
                ...
                if (Session["access_type"].ToString() == "ADMIN")
                {
                    System.Diagnostics.Debug.WriteLine("Admin Reached! main Click!");
                    Response.Redirect("~/Maintenance.aspx", false);
                    Context.ApplicationInstance.CompleteRequest();
                    //Response.Redirect("http://www.google.com", true);
                }
        ...
        protected void btn_login_maint_Click1(object sender, EventArgs e)
        {
            string email = tb_username.Text.Trim().ToLower();
            string pass = tb_password.Text.Trim();
            ...
            {
                //Response.Redirect("~/Maintenance.aspx", false);
                System.Diagnostics.Debug.WriteLine("Admin Reached! main Click 1!");
                Response.Redirect("~/Maintenance.aspx", false);
                Context.ApplicationInstance.CompleteRequest();
            }
        }
